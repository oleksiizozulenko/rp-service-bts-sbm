...
public class DeleteAttachment  implements java.io.Serializable {
    ...
    /**
     * Gets the auth value for this DeleteAttachment.
     * 
     * @return auth
     */
    ...
    /**
     * Sets the auth value for this DeleteAttachment.
     * 
     * @param auth
     */
    ...
    /**
     * Gets the options value for this DeleteAttachment.
     * 
     * @return options
     */
    ...
    /**
     * Sets the options value for this DeleteAttachment.
     * 
     * @param options
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sbmappservices72", ">DeleteAttachment"));
