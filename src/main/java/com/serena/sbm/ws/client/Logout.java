...
public class Logout  implements java.io.Serializable {
    ...
    /**
     * Gets the auth value for this Logout.
     * 
     * @return auth
     */
    ...
    /**
     * Sets the auth value for this Logout.
     * 
     * @param auth
     */
    ...
    /**
     * Gets the options value for this Logout.
     * 
     * @return options
     */
    ...
    /**
     * Sets the options value for this Logout.
     * 
     * @param options
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sbmappservices72", ">Logout"));
