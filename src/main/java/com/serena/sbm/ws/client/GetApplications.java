...
public class GetApplications  implements java.io.Serializable {
    ...
    /**
     * Gets the auth value for this GetApplications.
     * 
     * @return auth
     */
    ...
    /**
     * Sets the auth value for this GetApplications.
     * 
     * @param auth
     */
    ...
    /**
     * Gets the options value for this GetApplications.
     * 
     * @return options
     */
    ...
    /**
     * Sets the options value for this GetApplications.
     * 
     * @param options
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sbmappservices72", ">GetApplications"));
