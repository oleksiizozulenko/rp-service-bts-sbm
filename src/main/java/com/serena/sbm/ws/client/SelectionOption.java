...
public class SelectionOption  implements java.io.Serializable {
    private com.serena.sbm.ws.client.Identifier id;

    private java.math.BigInteger orderIndex;
    ...
    public SelectionOption(
           ...
           java.math.BigInteger orderIndex,
    ...
    /**
     * Gets the id value for this SelectionOption.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this SelectionOption.
     * 
     * @param id
     */
    ...
    /**
     * Gets the orderIndex value for this SelectionOption.
     * 
     * @return orderIndex
     */
    ...
    /**
     * Sets the orderIndex value for this SelectionOption.
     * 
     * @param orderIndex
     */
    public void setOrderIndex(java.math.BigInteger orderIndex) {
        this.orderIndex = orderIndex;
    }


    /**
     * Gets the extendedData value for this SelectionOption.
     * 
     * @return extendedData
     */
    ...
    /**
     * Sets the extendedData value for this SelectionOption.
     * 
     * @param extendedData
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SelectionOption)) return false;
        ...
        _equals = true && 
            ...
            ((this.orderIndex==null && other.getOrderIndex()==null) || 
             (this.orderIndex!=null &&
              this.orderIndex.equals(other.getOrderIndex()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getOrderIndex() != null) {
            _hashCode += getOrderIndex().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SelectionOption.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sbmappservices72", "SelectionOption"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sbmappservices72", "orderIndex"));
