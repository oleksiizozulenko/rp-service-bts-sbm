...
public class ReportType implements java.io.Serializable {
    ...
    public static final java.lang.String _ALLTYPES = "ALLTYPES";
    public static final ReportType LISTING = new ReportType(_LISTING);
    public static final ReportType ALLTYPES = new ReportType(_ALLTYPES);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sbmappservices72", "ReportType"));
    }
    /**
